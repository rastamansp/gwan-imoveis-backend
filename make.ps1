...
function Invoke-NpmTarget {
    param([string]$Script, [string[]]$NpmArgs = @())
...
function Invoke-Up      { Invoke-NpmTarget -Script 'run' -NpmArgs @('start:dev') }
function Invoke-Seed    { Invoke-NpmTarget -Script 'run' -NpmArgs @('db:seed') }
function Invoke-Migrate { Invoke-NpmTarget -Script 'run' -NpmArgs @('typeorm:migration:run') }
function Invoke-Test    { Invoke-NpmTarget -Script 'test' }
function Invoke-Build   { Invoke-NpmTarget -Script 'run' -NpmArgs @('build') }
